...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onPause() {
        super.onPause();
        // Step 1b: Obtain an instance of Shared Perference
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        // Step 1c: Obtain an instance of Shared Perference Editor for update later
    ...
    protected void onResume() {
        super.onResume();
        // Step 2a: Obtain an instance of Shared Preference
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
